...
Parser output on the bulk data: [mcparse/example_output_0.1.0.md](https://github.com/jakob-garde/mcparse/blob/main/example_output_0.1.0.md)

Examples messages compared with mcstas: [mcparse/failtest_output_0.1.0.md](https://github.com/jakob-garde/mcparse/blob/main/failtest_output_0.1.0.md)
...
The salvaged McStas static core runtime simulation code is found here: [simcore.h](https://github.com/jakob-garde/mctrace/blob/main/simcore/simcore.h) and [simlib.h](https://github.com/jakob-garde/mctrace/blob/main/simcore/simlib.h).
